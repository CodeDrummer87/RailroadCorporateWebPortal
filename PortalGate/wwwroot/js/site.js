...
function GetRailroadList() {
	$.ajax({
		url: "https://localhost:44333/data/getRailroadList",
		method: 'GET',
...
function GetUnitList() {
	...
	let industryId = $(selectedIndustry).attr('id');
	$.ajax({
		url: "https://localhost:44333/data/getUnitsCount?railroadId=" + railroadId + "&industryId=" + industryId,
		method: 'GET',
...
function GetIndustryList() {
	$.ajax({
		url: 'https://localhost:44333/data/getIndustryList',
		method: 'GET',
...
function GetUnitsAndDisplay(railroadId, industryId) {
	$.ajax({
		url: 'https://localhost:44333/data/getUnitList?railroadId=' + railroadId + '&industryId=' + industryId + '&page=' + currentPage,
		method: 'GET',
